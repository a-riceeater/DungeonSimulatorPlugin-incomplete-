...
public class commands implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("storm")) {
            player.getInventory().addItem(ItemManager.STORM_HELMET);
        }
        if (cmd.getName().equalsIgnoreCase("necronarmor")) {
            player.getInventory().addItem(ItemManager.NECRONS_HELMET);
            player.getInventory().addItem(ItemManager.NECRONS_CHESTPLATE);
            player.getInventory().addItem(ItemManager.NECRONS_LGEGINGS);
        }
        return true;
    }
}
